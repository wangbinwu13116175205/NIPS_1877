...
from dataset_pems04 import get_dataloader
from main_model import PriSTI_Pems04
...
def main(args):
    ...
    config["diffusion"]["adj_file"] = 'pems-04'
    config["seed"] = SEED
    ...
    train_loader, valid_loader, test_loader, scaler, mean_scaler = get_dataloader(
        ...
        is_interpolate=config["model"]["use_guide"], num_workers=args.num_workers, target_strategy=args.targetstrategy,rate=args.rate
    )

    model = PriSTI_Pems04(config, args.device).to(args.device)
